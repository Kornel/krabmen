...
write.table(b, file = 'result-PRAD.clinical.csv', row.names = F, sep = ';')
...
write.table(b, file = 'result-TABLE_S1_PRAD.csv', row.names = F, sep = ';')
...
write.table(b, file = 'result-THCA.clinical.csv', row.names = F, sep = ';')
...
write.table(b, file = 'result-THCA_RNA_Subtypes.csv', row.names = F, sep = ';')
